...
dog_image=pygame.transform.scale(pygame.image.load('cute.webp').convert_alpha(),(200,200))

dog_rect=dog_image.get_rect(center=(screen_width//2,screen_height//2-30))
